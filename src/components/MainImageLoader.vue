...
<!--<script setup>
import {inject, onMounted, ref, watch, defineProps } from 'vue' //,watch computed,toRaw,nextTick
...
const props = defineProps({
  isRunModels: { type: Boolean, default: false }
});
...
loadImageToCanvas('images/dragdrop.png'); //await 
...
export default defineComponent({
  setup() {
    ...
    const { getRootProps, getInputProps, ...rest } = useDropzone({onDrop, noClick:true, accept:"image/png,image/gif,image/jpeg,image/webp" }); //{ getRootProps, getInputProps, }
    return {
